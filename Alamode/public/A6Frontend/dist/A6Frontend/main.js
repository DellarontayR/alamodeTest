...
var routes = [
    ...
    { path: 'account', component: _components_mookie_account_mookie_account_component__WEBPACK_IMPORTED_MODULE_8__["MookieAccountComponent"], canActivate: [_auth_guard__WEBPACK_IMPORTED_MODULE_19__["AuthGuard"]] },
    { path: 'shopping-cart', component: _components_mookie_cart_mookie_cart_component__WEBPACK_IMPORTED_MODULE_9__["MookieCartComponent"], canActivate: [_auth_guard__WEBPACK_IMPORTED_MODULE_19__["AuthGuard"]] },
    { path: 'ontheway', component: _components_mookie_checkout_mookie_checkout_component__WEBPACK_IMPORTED_MODULE_10__["MookieCheckoutComponent"], canActivate: [_auth_guard__WEBPACK_IMPORTED_MODULE_19__["AuthGuard"]] },
    { path: 'orders/:orderId', component: _components_mookie_orders_mookie_orders_component__WEBPACK_IMPORTED_MODULE_11__["MookieOrdersComponent"], canActivate: [_auth_guard__WEBPACK_IMPORTED_MODULE_19__["AuthGuard"]] },
    ...
    {
        path: 'management', component: _components_mookie_manage_mookie_manage_component__WEBPACK_IMPORTED_MODULE_12__["MookieManageComponent"], canActivate: [_admin_guard__WEBPACK_IMPORTED_MODULE_20__["AdminGuard"]],
        children: [{
                path: 'users',
    ...
    MookieAccountComponent.prototype.ngOnInit = function () {
        ...
        this.userService.getUser().subscribe(function (data) {
            if (data.success) {
                ...
                _this.userEmail = data.user.email;
...
var UserService = /** @class */ (function () {
    function UserService(http, windowRef) {
        ...
        this.getUser = function () {
            var _this = this;
            return this.http.post('/api/getUser').pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (res) { console.log(res); return res; }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(function (err) { return _this.handleError(err); }));
        };
